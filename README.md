# Go2 — RL Locomotion in Isaac Lab

![poster](media/poster.png)

Massively parallel reinforcement-learning simulation of the **Unitree Robotics Go2**
in [NVIDIA Isaac Lab](https://github.com/isaac-sim/IsaacLab), rendered at
1920×1080 with a tracking camera. The policy walks procedurally generated rough terrain (stair pyramids, random boxes).

▶ **Demo video:** [`videos/go2-rough-locomotion.mp4`](videos/go2-rough-locomotion.mp4)

## Task

| | |
|---|---|
| Environment | `Isaac-Velocity-Rough-Unitree-Go2-v0` |
...
/path/to/this/repo/scripts/encode.sh rl-video-step-0.mp4 go2-rough-locomotion.mp4
...
```bash
export VIEWER_FOLLOW=robot VIEWER_HIDE_COMMANDS=1 VIEWER_EYE=1.6,1.6,0.9 VIEWER_LOOKAT=0,0,0.0
```
